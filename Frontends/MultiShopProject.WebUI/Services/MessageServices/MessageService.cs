using MultiShopProject.Dto.MessageDtos;

namespace MultiShopProject.WebUI.Services.MessageServices
{
...
//http://localhost:7199/api/UserMessages/GetMessageSendbox?id=a
